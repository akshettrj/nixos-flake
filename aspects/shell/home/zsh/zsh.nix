...
}:
{
    config =
        let
            ...
            deskenvs_meta = import ../../../core/metadata/programs/desktop_environments.nix {
                ...
                initContent = lib.mkMerge [
                    ...
                    (lib.mkOrder 1000 (
                        ...
                        + ''
                            ...
                            bindkey -s '^o' "${if biryani_file_explorers.main == "lf" then "lfcd" else "yy"}\n"
                    ...
                    (lib.mkOrder 2000 (
                        lib.optionalString
                            (biryani_deskenvs.enable && builtins.length (lib.attrNames biryani_deskenvs.defaults) > 0) # sh
