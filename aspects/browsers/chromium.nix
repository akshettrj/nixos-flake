...
}:
{
    ...
    config =
        let
            ...
            palette =
                if biryani_theming.matugen.integrations.chromium.enable then
            ...
            themeArgs = lib.optionals biryani_theming.matugen.integrations.chromium.enable [
        ...
        lib.mkIf (biryani_browsers.enable && biryani_browsers.chromium.enable) {
            programs.chromium = {
                enable = true;
                commandLineArgs = biryani_browsers.chromium.cmd_args ++ themeArgs;
            };
        };
}
